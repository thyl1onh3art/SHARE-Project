  ...
  async connect() {
    try {
      ...
      const mongoUri = process.env.NODE_ENV === 'test'
        ? (process.env.MONGO_URI_TEST || process.env.MONGO_URI || process.env.MONGODB_URI)
        : (process.env.MONGO_URI || process.env.MONGODB_URI || process.env.MONGO_PUBLIC_URL || process.env.MONGO_URL || process.env.DATABASE_URL);
